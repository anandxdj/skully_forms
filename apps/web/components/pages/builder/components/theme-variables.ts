...
export const THEME_ILLUSTRATIONS: Partial<Record<Theme, ThemeIllustration>> = {
  skullyLight: {
    skeleton: "/assets/skeletons/Skeleton%20with%20jacket%20with%20cookie.png",
    background: "/assets/background/pink%20background.png",
  },
  skullyDark: {
    skeleton: "/assets/skeletons/Skeleton%20Gaming.png",
    background: "/assets/background/dark%20background.png",
  },
  skullyNeon: {
    skeleton: "/assets/skeletons/Skeleton%20Gaming.png",
    background: "/assets/background/Dark%20Background%202.png",
  },
  skullyGold: {
    skeleton: "/assets/skeletons/skeleton_with_money.png",
    background: "/assets/background/Golden%20Leaf.png",
  },
  skullyGreen: {
    skeleton: "/assets/skeletons/Green-skeleton-with-plants.png",
    background: "/assets/background/Leaf%20Background.png",
  },
  skullyParty: {
    skeleton: "/assets/skeletons/Skeleton%20Dancing.png",
    background: "/assets/background/pink%20stage.png",
  },
  slate: {
    skeleton: "/assets/skeletons/Skeleton%20with%20laptop.png",
  },
  cyberpunk: {
    skeleton: "/assets/skeletons/Skeleton%20Gaming.png",
  },
  sunset: {
    skeleton: "/assets/skeletons/Skeleton%20with%20skateboard.png",
  },
  forest: {
    skeleton: "/assets/skeletons/Green-skeleton-with-plants.png",
    background: "/assets/background/Leaf%20Background.png",
...
export const FIELD_TYPE_SKELETONS: Record<string, string> = {
  TEXT:     "/assets/fun_skeleton/frame_005%202.png",
  EMAIL:    "/assets/fun_skeleton/frame_001%202.png",
  TEXTAREA: "/assets/fun_skeleton/frame_008%202.png",
  NUMBER:   "/assets/fun_skeleton/frame_018%202.png",
  DATE:     "/assets/fun_skeleton/frame_045%202.png",
  SELECT:   "/assets/fun_skeleton/frame_012%202.png",
  RADIO:    "/assets/fun_skeleton/frame_002%202.png",
  CHECKBOX: "/assets/fun_skeleton/frame_030%202.png",
  RATING:   "/assets/fun_skeleton/frame_015%202.png",
  FILE:     "/assets/fun_skeleton/frame_040%202.png",
};
